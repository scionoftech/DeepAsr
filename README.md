...
DeepAsr will provide multiple Speech Recognition using Deep Neural Network architectures, Currenly it provides Baidu's Deep Speech 2 using Keras (Tensorflow).
